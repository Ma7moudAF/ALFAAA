...
تم تطوير وبرمجه السورس بواسطه مصطفي 𝐌.𝐤
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MADISON111110/M-K/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1183747742,1208165035,1744308503,1041487390,1953932319,1917675319,1742679098}   
...
var = true
elseif tonumber(user_id) == tonumber(1041487390) then
var = true
elseif tonumber(user_id) == tonumber(1183747742) then
var = true
elseif tonumber(user_id) == tonumber(1917675319) then
var = true
elseif tonumber(user_id) == tonumber(1742679098) then
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or '𝐌.𝐤'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "SO_M_K")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𓆩𝐒𝐎𝐔𝐑𝐂𝐄 𝐌.𝐊𓆪")  
...
local SO_M_K = database:get(bot_id..'text:ch:user')
if SO_M_K then
send(msg.chat_id_, msg.id_,'['..SO_M_K..']')
else
...
local Namebot = (database:get(bot_id..'Name:Bot') or '𝐌.𝐤') 
local DRAGON_Msg = { 
...
os.execute('wget https://raw.githubusercontent.com/MADISON111110/M-K/main/DRAGON.lua')
...
local Text = [[ 
[اضغط هنا وانضم الي قناه السورس](t.me/SO_M_K)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/SO_M_K"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
usertext = '\n⋆ العضو ⤌ ['..result.title_..'](t.me/'..(username or 'SO_M_K')..')'
status  = '\n⋆ تم ترقيته مطور'
...
usertext = '\n⋆ العضو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_M_K')..')'
status  = '\n⋆ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⋆ العضو ⤌ [ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ](T.ME/'..(data.username_ or 'SO_M_K')..') \n⋆ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "𝐌.𝐤")
...
send(msg.chat_id_,0,"⋆ العضو : {["..data.first_name_.."](T.ME/SO_M_K)}\n⋆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⋆ عذرا ⤌ {["..data.first_name_.."](T.ME/SO_M_K)}\n⋆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/MADISON111110/M-K/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/MADISON111110/M-K/main/library')
os.execute('wget https://raw.githubusercontent.com/MADISON111110/M-K/main/File_Bot')
send(msg.chat_id_, msg.id_,'⋆ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/SO_M_K"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
❍[◍ 𝐃𝐞𝐯 𝐃𝐚𝐧𝐢𝐞𝐥 ](t.me/Mk_Dad)

❍[◍ 𝐃𝐞𝐯 𝐊𝐚𝐦𝐚𝐥 ](t.me/W_H_U)

❍[◍ 𝐃𝐞𝐯 𝐇𝐚𝐬𝐬𝐚𝐧 ](t.me/MooD103)

❍[◍ 𝐃𝐞𝐯 𝐀𝐯𝐚𝐭𝐚𝐫 ](t.me/UN_AVATAR)
...
keyboard.inline_keyboard = {
{
{text = '𓆩𝐒𝐎𝐔𝐑𝐂𝐄 𝐌.𝐊𓆪', url = "https://t.me/SO_M_K"},
},
{
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MADI_PICK/31&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end


if text == 'العزايزي' or text == 'المبرمج عزايزي' or text == 'عزايزي' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
...
if text == 'رزان' or text == 'قلب ماديسون' or text == 'رزان القمر' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
⋆ عن طريق معرفي بلاسفل..↑↓
]]
...
if text == 'دانيال' or text == 'المبرمج دانيال' or text == 'دانيال مبرمج السورس' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
⋆ عن طريق معرفي بلاسفل..↑↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◍ 𝐃𝐞𝐯 𝐃𝐚𝐧𝐢𝐞𝐥 ⋆',url="t.me/Mk_Dad"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Mk_Dad&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'كمال' or text == 'المبرمج كمال' or text == 'كمال مبرمج السورس' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
⋆ عن طريق معرفي بلاسفل..↑↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◍ 𝐃𝐞𝐯 𝐊𝐚𝐦𝐚𝐥 ⋆',url="t.me/W_H_U"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/W_H_U&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'افتار' or text == 'المطور افتار' or text == 'افتار المطور افتار' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
⋆ عن طريق معرفي بلاسفل..↑↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◍ 𝐃𝐞𝐯 𝐀𝐯𝐚𝐭𝐚𝐫 ⋆',url="t.me/UN_AVATAR"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/UN_AVATAR&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'بودي' or text == 'المطور بودي' or text == 'بودي المطور افتار' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
⋆ عن طريق معرفي بلاسفل..↑↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◍ 𝐃𝐞𝐯 𝐁𝐨𝐝𝐲 ⋆',url="t.me/BooDY1890"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BooDY1890&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'حسن' or text == 'المبرمج حسن' or text == 'حسن مبرمج السورس' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
⋆ عن طريق معرفي بلاسفل..↑↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◍ 𝐃𝐞𝐯 𝐇𝐚𝐬𝐬𝐚𝐧 ⋆',url="t.me/MooD103"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MooD103&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بوت اليوتيوب ♥️',url="t.me/AL_YOUT_BOT"}},
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[ها هو بوت التواصل يحبيب قلبي..🥺♥️](t.me/E_H_M_BOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩𝐒𝐎𝐔𝐑𝐂𝐄 𝐌.𝐊𓆪', url="t.me/SO_M_K"}}, 
{{text = '𝐔𝐒𝐄𝐑 𝐌.𝐊𓆪', url="t.me/USER_M_K"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MADI_PICK/31&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'العاب السورس' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⋆ مـن قبـل ⤌ [ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ](T.ME/'..(data.username_ or 'SO_M_K')..') \n⋆ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⋆ مـن قبـل ⤌ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SO_M_K')..') \n⋆ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n⋆تم قفل البوتات بالطرد\n⋆تم وضع الايدي بدون صوره\n⋆تم قفل التكرار بالطرد\n⋆تم قفل الروابط\n⋆تم قفل التوجيه\n⋆تم قفل الملصقات\n⋆تم قفل المتحركه\n⋆تم قفل الفيديو\n⋆تم قفل السب\n⋆تم قفل التعديل\n⋆تم قفل الفارسيه\n⋆تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه ⤌[ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ](T.ME/'..(data.username_ or 'SO_M_K')..')')   
end,nil) 
end
...
if tonumber(result.sender_user_id_) == tonumber(1917675319) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر المطور افتار عام")
return false 
end
...
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر المبرمج كمال عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1953932319) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر قلب ماديسون عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1041487390) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر المبرمج حسن عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1953932319) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر قلب ماديسون عام")
...
if result.id_ == tonumber(1917675319) then
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر المطور افتار عام")
return false 
end
...
if result.id_ == tonumber(1041487390) then
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر المبرمج حسن عام")
return false 
end
...
if tonumber(userid) == tonumber(1917675319) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر المطور افتار عام")
return false 
end
...
if tonumber(userid) == tonumber(1041487390) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر المبرمج حسن عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1917675319) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع كتم المطور افتار عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1208165035) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع كتم مبرمج السورس عام")
...
if tonumber(result.sender_user_id_) == tonumber(1744308503) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع كتم المبرمج كمال عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1953932319) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع كتم قلب ماديسون عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1041487390) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع كتم المبرمج حسن عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MADISON111110/M-K/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⋆ اهلا بك في متجر ملفات 𝐌.𝐤\n⋆ ملفات السورس ↓\n≪╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸≫\n\n"
local TextE = "\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n⋆ علامة تعني { ✔️ } ملف مفعل\n⋆ علامة تعني { x } ملف معطل\n⋆ قناة سورس 𝐌.𝐤 ↓\n".."⋆ [اضغط هنا لدخول](t.me/SO_M_K) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/MADISON111110/M-K/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_,"⋆ عذرا الملف لايدعم سورس 𝐌.𝐤 \n") 
end
return false
end
...
if text == ("مسح قائمه 𝐌.𝐤") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n⋆ تم مسح قائمه 𝐌.𝐤')
return false
end

if text == 'قائمه 𝐌.𝐤' and Sudo(msg) then
...
if text == ("رفع 𝐌.𝐤") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local SO_M_K = database:get(bot_id..'text:ch:user')
if SO_M_K then
send(msg.chat_id_, msg.id_,'['..SO_M_K..']')
...
if text and text:match("^رفع 𝐌.𝐤 @(.*)$") and Sudo(msg) then
local username = text:match("^رفع 𝐌.𝐤 @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local SO_M_K = database:get(bot_id..'text:ch:user')
if SO_M_K then
send(msg.chat_id_, msg.id_,'['..SO_M_K..']')
...
if text and text:match("^رفع 𝐌.𝐤 (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع 𝐌.𝐤 (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local SO_M_K = database:get(bot_id..'text:ch:user')
if SO_M_K then
send(msg.chat_id_, msg.id_,'['..SO_M_K..']')
...
if text == ("تنزيل 𝐌.𝐤") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local SO_M_K = database:get(bot_id..'text:ch:user')
if SO_M_K then
send(msg.chat_id_, msg.id_,'['..SO_M_K..']')
...
if text and text:match("^تنزيل 𝐌.𝐤 @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل 𝐌.𝐤 @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local SO_M_K = database:get(bot_id..'text:ch:user')
if SO_M_K then
send(msg.chat_id_, msg.id_,'['..SO_M_K..']')
...
if text and text:match("^تنزيل 𝐌.𝐤 (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل 𝐌.𝐤 (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local SO_M_K = database:get(bot_id..'text:ch:user')
if SO_M_K then
send(msg.chat_id_, msg.id_,'['..SO_M_K..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n⋆ لعضو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_M_K')..')'
status  = '\n⋆ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n⋆ العضو ⤌ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⋆ العضــو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_M_K')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⋆ العضو ⤌ ['..result.title_..'](t.me/'..(text1[3] or 'SO_M_K')..')'..'\n⋆ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {}   
keyboard.inline_keyboard = {  
 {{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙿𝙰𝚁𝙸𝚂》', url="t.me/SO_M_K"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
database:set(bot_id.."SO_M_K:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⋆تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SO_M_K:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."SO_M_K:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس 𝐌.𝐤 يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or '𝐌.𝐤').." غادر" or text == 'غادر' then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or '𝐌.𝐤').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or '𝐌.𝐤')
local DRAGON_Msg = {
'⋆ يوه '..Namebot..' زهق منك😒',
'⋆ نعم ياعيون '..Namebot..' 😻💓',
'⋆ عايز اي من '..Namebot..' 🙄💛',
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_M_K')..')'
local iduser = result.sender_user_id_
