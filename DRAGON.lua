...
sudo_users = {SUDO,1804133252,1905542939,1612150498}   
...
var = true 
elseif tonumber(user_id) == tonumber(1612150498) then
var = true  
elseif tonumber(user_id) == tonumber(1905542939) then
var = true  
...
local Key = {
{'المـبرمـج مـاديـسـون'},
{'الـمبرمج اسـلام','الـمطـور بـرايـن'},
{'قناة السورس','التواصل'},
{'العوده✨'},
}
send_inline_key(msg.chat_id_,Text,Key)
...
os.execute('wget https://raw.githubusercontent.com/MADISON111110/FIRE/main/BANDA.lua')
...
if text == '/start' and Debn(msg) then 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Qtdao/69&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' ⌯ اصدار سورس فاير{ S:12✓}')
end

if text == 'المـبرمـج مـاديـسـون'  then
local Text = [[
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MaDiSoOnN_1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'الـمبرمج اسـلام' then
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐞𝐯 𝐄𝐬𝐥𝐚𝐦 ✰.',url="t.me/Q_0_ll"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/SO_FIR"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'ماديفاير مبرمج السورس' and Debn(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
「المبرمج ماديفاير لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓」
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SO_FIR&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard.inline_keyboard = {
{{text = '𝐃𝐞𝐯 𝐌𝐚𝐝𝐢𝐬𝐨𝐧 ✰.', url="t.me/MaDiSoOnN_1"}},
{{text = '𝐃𝐞𝐯 𝐁𝐫𝐚𝐢𝐧 ✰.',url="t.me/FACKYOOOOOU"},{text = '𝐃𝐞𝐯 𝐄𝐬𝐥𝐚𝐦', url="t.me/U_FCU"}},
{{text = '𝐂𝐇 𝐅𝐈𝐑𝐄 ✰', url="t.me/SO_FIR"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'ماديفاير' or text == 'المبرمج ماديفاير' or text == 'احمد' then
local Text = [[
المبرمج اسلام لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ˋˏTˎˊˋˏOˎˊ ˋˏAˎˊˋˏSˎˊˋˏKˎˊ', url="t.me/UU_shetos"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/vagwg/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if tonumber(result.sender_user_id_) == tonumber(1612150498) then  
send(msg.chat_id_, msg.id_, " ⌯ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1905542939) then  
send(msg.chat_id_, msg.id_, " ⌯ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1612150498) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1905542939) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n ⌯ الـعـضو   ⇠ ['..result.title_..'](t.me/'..(username or 'SO_FIR')..')'
status  = '\n ⌯ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(1612150498) then  
send(msg.chat_id_, msg.id_, " ⌯ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1905542939) then  
send(msg.chat_id_, msg.id_, " ⌯ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MADI_PICK1/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'كسمهم' then
local Text = [[
]]
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🌚💕](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚💕](t.me/SO_FIR)')
return false
end
end
end
